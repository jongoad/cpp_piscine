...
printf "${RED}Input: ${CLEAR}./replace ./test_files/test.txt test \"\"\n\n"
...
printf "${RED}Input: ${CLEAR}./replace ./test_files/test.txt \"\" \"\"\n\n"
...
printf "${RED}Input: ${CLEAR}./replace ./test_files/test.txt nope YES\n\n"
...
printf "${RED}Input: ${CLEAR}./replace ./test_files/test.txt test YES\n\n"
